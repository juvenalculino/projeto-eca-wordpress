...
class Vcard_CV_Resume_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Vcard_CV_Resume_About_Widget',
			__('VW About us', 'vcard-cv-resume'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vcard-cv-resume' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vcard-cv-resume'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vcard-cv-resume'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vcard-cv-resume'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vcard-cv-resume'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vcard-cv-resume'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vcard-cv-resume'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vcard_cv_resume_about_custom_load_widget() {
	register_widget( 'Vcard_CV_Resume_About_Widget' );
}
add_action( 'widgets_init', 'vcard_cv_resume_about_custom_load_widget' );