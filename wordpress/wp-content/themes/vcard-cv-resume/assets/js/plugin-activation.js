jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vcard_cv_resume_plugin_activate_plugin;
    ...
    $(document).on('click', '.vcard-cv-resume-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vcard-cv-resume-plugin-install');
                button.addClass('button-primary vcard-cv-resume-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vcard-cv-resume-recommended-plugins .vcard-cv-resume-activation-note').css('display','block');
    ...
    $(document).on('click', '.vcard-cv-resume-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vcard-cv-resume-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vcard-cv-resume-recommended-plugins').css('display','none');
    });
