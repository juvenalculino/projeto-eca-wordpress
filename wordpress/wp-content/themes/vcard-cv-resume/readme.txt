...
= 0.1.2 =
* Added conditions for header when slider is off.
...
* Added woocommerce product sale badge border radius option in customizer. 
...
* Resolved error of block pattern tab get started.
...
* Added ibtana template classes in responsive.
* Updated language folder.
...
= 0.3.7 =
* Remove default menus color and toggle button bg color.
...
* Added css for post button in customizer.
...
* Added 404 page,no result and social icon in other setting.
* Added css for 404 button.
* Update language folder. 
...
= 0.5.2 =
* Resolved css for responsive media.
...
* Added no result section in customizer.
...
* Added show / hide post navigation text in single post.
...
* Added css for checkout and cart page for woocommerce.
* Added slider button text and url option in customizer.
* Update pot file.

= 0.6.2 =
* Added css for checkout and cart page for woocommerce.
* Added target balnk in social icon. 
...
* Added dropdown categories for sidebar preview.
* Update pot file.
...
Vcard CV Resume WordPress Theme, Copyright 2021 VWThemes
Vcard CV Resume is distributed under the terms of the GNU GPL.
...
== Fonts ==
* Josefin+Sans *
* Source : https://fonts.google.com/specimen/Josefin+Sans?query=Josefin+Sans
...
Blog Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/745612

Blog Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/912909

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vcard-cv-resume/
