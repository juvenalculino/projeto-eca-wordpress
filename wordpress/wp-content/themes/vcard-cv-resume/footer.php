        ...
        <?php if (get_theme_mod('vcard_cv_resume_footer_hide_show', true)){ ?>
            <aside id="footer" class="copyright-wrapper" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'vcard-cv-resume' ); ?>">
                <div class="container">
                    ...
                    ?>
                    <div class="row">
                        <div class="<?php echo !is_active_sidebar('footer-1') ? 'footer_hide' : esc_attr($vcard_cv_resume_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
                            <?php if (is_active_sidebar('footer-1')) : ?>
                                <?php dynamic_sidebar('footer-1'); ?>
                            <?php else : ?>
                                <aside id="search" class="widget py-3" role="complementary" aria-label="firstsidebar">
                                    <h3 class="widget-title"><?php esc_html_e( 'Search', 'vcard-cv-resume' ); ?></h3>
                                    <?php get_search_form(); ?>
                                </aside>
                            <?php endif; ?>
                        </div>

                        <div class="<?php echo !is_active_sidebar('footer-2') ? 'footer_hide' : esc_attr($vcard_cv_resume_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block pe-2">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-3') ? 'footer_hide' : esc_attr($vcard_cv_resume_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-4') ? 'footer_hide' : esc_attr($vcard_cv_resume_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
                            <?php if (is_active_sidebar('footer-4')) : ?>
                                <?php dynamic_sidebar('footer-4'); ?>
                            <?php else : ?>
                                <aside id="categories" class="widget py-3" role="complementary">
                                    <h3 class="widget-title"><?php esc_html_e( 'Categories', 'vcard-cv-resume' ); ?></h3>
                                    <ul>
